const DICTIONARY = {
  en: {
    ...
    "ad_gate_sub": "Authenticate with your admin password.",
    ...
    // ===== PDF Report =====
    "rpt_eyebrow": "Neurocognitive Assessment · Full Report",
    "rpt_cover_title_1": "Cognitive",
    "rpt_cover_title_2": "Performance",
    "rpt_cover_title_3": "Profile",
    "rpt_cover_sub": "An evidence-based analysis of visual working memory capacity, attentional filtering, and executive control — across three validated cognitive science tests.",
    "rpt_cand_participant": "Participant",
    "rpt_cand_handle": "Handle",
    "rpt_cand_assessdate": "Assessment Date",
    "rpt_cand_completedat": "Completed At",
    "rpt_cand_totaltrials": "Total Trials",
    "rpt_cand_age": "Age",
    "rpt_component_scores": "Component Scores",
    "rpt_report_id": "Report ID",
    "rpt_confidential": "CONFIDENTIAL",

    "rpt_sec1_label": "SECTION ONE",
    "rpt_sec1_title": "Working Memory Capacity",
    ...
    "rpt_sec2_label": "SECTION TWO",
    "rpt_sec2_title": "Working Memory Filtering",
    ...
    "rpt_sec3_label": "SECTION THREE",
    "rpt_sec3_title": "Attention Network Task",
    ...
    "rpt_wyd_title": "WHAT YOU DID IN THIS TASK",
    "rpt_results_mean_title": "WHAT THESE RESULTS MEAN",
    "rpt_glossary_title": "PLAIN-LANGUAGE GLOSSARY",

    "rpt_m_cowansk": "Cowan's K",
    "rpt_m_cowansk_sub": "Memory capacity estimate",
    ...
    "rpt_m_fastest_sub": "Quickest correct response",
    "rpt_m_slowest": "Slowest Correct",
    "rpt_m_slowest_sub": "Most deliberate correct response",
    "rpt_m_beststreak": "Best Streak",
    "rpt_m_beststreak_unit": "in a row",
    "rpt_m_beststreak_sub": "Consecutive correct trials",

    "rpt_m_cowansk_dist": "Cowan's K (Distractor)",
    "rpt_m_cowansk_dist_sub": "Memory capacity under load",
    "rpt_m_execeff": "Executive Efficiency",
    "rpt_m_execeff_sub": "Distractor filtering ability",
    "rpt_m_execspeed": "Executive Speed",
    "rpt_m_execspeed_sub_faster": "Faster with distractors",
    "rpt_m_execspeed_sub_slower": "Slower with distractors",

    "rpt_change_label": "CHANGE IN MEMORY CAPACITY",
    "rpt_change_text": "{name}'s memory capacity {direction} by {delta} points when decoy squares were added (K={k1} → K={k2}).",
    "rpt_change_increased": "increased",
    "rpt_change_decreased": "decreased",
    "rpt_task1_label": "TASK 1",
    "rpt_task2_label": "TASK 2",
    "rpt_task1_pure": "Task 1 (Pure)",
    "rpt_task2_distractor": "Task 2 (Distractor)",

    "rpt_chart_k_title": "MEMORY CAPACITY (COWAN'S K) BY NUMBER OF SQUARES",
    "rpt_chart_k_sub": "Higher bars = more items held in memory.",
    "rpt_chart_acc_title": "ACCURACY BY NUMBER OF SQUARES",
    "rpt_chart_acc_sub": "The dashed line (50%) = random guessing. Above it = genuine memory.",
    "rpt_chart_kcompare_title": "MEMORY CAPACITY: TASK 1 VS TASK 2",
    "rpt_chart_kcompare_sub": "Pink = Task 1 (no distractors) · Green = Task 2 (with distractors)",
    "rpt_chart_acccompare_title": "ACCURACY COMPARISON: TASK 1 VS TASK 2",
    "rpt_chart_acccompare_sub": "How accuracy held up with distractors present.",
    "rpt_chart_cuespeed_title": "RESPONSE SPEED BY CUE TYPE",
    "rpt_chart_cuespeed_sub": "Lower bars = faster responses.",
    "rpt_chart_congr_title": "CONGRUENT VS INCONGRUENT ARROWS",
    "rpt_chart_congr_sub": "The {gap}ms gap between these bars = Executive Control score.",

    "rpt_spark_title": "RESPONSE SPEED",
    ...
    "rpt_gloss_setsize_term": "Set Size (N)",
    "rpt_gloss_setsize_def": "The number of coloured squares shown in a single trial. N=1 is one square; N=8 is eight squares at once.",
    "rpt_gloss_cowanskdist_term": "Cowan's K (Distractor)",
    "rpt_gloss_cowanskdist_def": "Your memory capacity when white decoy squares were also on screen. A higher score than Task 1 means your brain focused better under extra visual noise.",
    "rpt_gloss_execeff_term": "Executive Efficiency",
    "rpt_gloss_execeff_def": "How effectively your brain blocked out distractor squares, expressed as a percentage change in capacity relative to the distraction-free baseline.",
    "rpt_gloss_execspeed_term": "Executive Speed",
    "rpt_gloss_execspeed_def": "The response-time difference between the pure and distractor tasks. A negative number means you responded faster with distractors present.",
    "rpt_gloss_distractoreffect_term": "Distractor Effect",
    "rpt_gloss_distractoreffect_def": "The overall difference in memory performance between Task 1 (no decoys) and Task 2. A positive change means distractors actually helped — which is unusual and interesting.",
    "rpt_gloss_alerting_term": "Alerting Network",
    "rpt_gloss_alerting_def": "Your brain's general 'heads-up' system. When you see a warning signal, does your brain get ready faster?",
    "rpt_gloss_orienting_term": "Orienting Network",
    "rpt_gloss_orienting_def": "Your brain's ability to point attention at a specific location before something appears there.",
    "rpt_gloss_executive_term": "Executive Control",
    "rpt_gloss_executive_def": "Your brain's ability to override an automatic response when surrounding arrows point the wrong way.",
    "rpt_gloss_congr_term": "Congruent vs Incongruent",
    "rpt_gloss_congr_def": "Congruent = surrounding arrows point the same direction as the target (easy). Incongruent = they point the opposite direction (hard).",
    "rpt_gloss_flanker_term": "Flanker Arrows",
    "rpt_gloss_flanker_def": "The arrows that surround the target centre arrow. They may match or oppose the target direction.",
    "rpt_gloss_cuetypes_term": "Cue Types",
    "rpt_gloss_cuetypes_def": "None = no warning. Center = a flash in the middle. Spatial = a flash exactly where the target will appear. Double = flashes in two places.",

    "rpt_net_alerting_label": "ALERTING NETWORK",
    "rpt_net_alerting_body": "A time-warning flash changed response speed by {val}ms. This reflects how well the brain picks up on 'something is coming soon' signals.",
    "rpt_net_orienting_label": "ORIENTING NETWORK",
    ...
    "rpt_m_congruentrt": "Congruent RT",
    "rpt_m_congruentrt_sub": "Easy trials (arrows agree)",
    "rpt_m_incongruentrt": "Incongruent RT",
    "rpt_m_incongruentrt_sub": "Hard trials (arrows conflict)",
    "rpt_m_alerteff": "Alerting Efficiency",
    "rpt_m_alerteff_sub": "Speed-corrected score",
    "rpt_m_orienteff": "Orienting Efficiency",
    "rpt_m_orienteff_sub": "Speed-corrected score",
    "rpt_m_alerteff_sub2": "Normal range ≈ 0.3–0.5 r/s",
    "rpt_m_orienteff_sub2": "Negative = no spatial benefit",
    ...
    "rpt_interp2_change_lower": "{n} points lower",
    "rpt_interp2_change_higher": "{n} points higher",
    "rpt_interp2_resilience_high": "high resilience to interference",
    "rpt_interp2_resilience_mod": "moderate resilience to interference",
    "rpt_interp2_resilience_low": "notable sensitivity to interference",
    "rpt_interp3": "The Attention Network Task revealed a profile across three brain systems: alerting ({alerting}ms benefit), orienting ({orienting}ms benefit), and executive control ({executive}ms cost when resolving conflict). Congruent trials averaged {rtC}ms versus {rtI}ms on incongruent trials, across {trials} total trials at {acc}% overall accuracy.",
    "rpt_interp3_placeholder": "[Placeholder: deeper narrative synthesis of this candidate's attention profile would be generated here.]",

    "rpt_change_placeholder": "[Placeholder: additional interpretive context on this pattern would be generated here.]",

    "rpt_summary_eyebrow": "OVERALL SUMMARY",
    "rpt_summary_title": "Cognitive Profile Summary",
    "rpt_summary_sub": "Integrated performance across all three assessment modules",
    "rpt_composite_label": "COMPOSITE SCORE",
    "rpt_composite_text": "A combined score across all 7 component metrics. {score} places {name} in the '{band}' band.",
    "rpt_bands_title": "PERFORMANCE BANDS",
    "rpt_band_developing": "Developing",
    "rpt_band_average": "Average",
    "rpt_band_aboveavg": "Above Avg",
    "rpt_band_strong": "Strong",
    "rpt_band_exceptional": "Exceptional",

    "rpt_allscores_title": "ALL COMPONENT SCORES (0–100)",
    "rpt_allscores_legend_green": "Green ≥ 70 (Strong)",
    "rpt_allscores_legend_amber": "Amber 40–69 (Moderate)",
    "rpt_allscores_legend_red": "Red < 40 (Developing)",

    "rpt_strengths_title": "↑ COGNITIVE STRENGTHS",
    "rpt_dev_title": "◇ AREAS FOR DEVELOPMENT",
    "rpt_strength_item": "<strong>{name}:</strong> {score}th percentile (illustrative).",
    "rpt_strength_placeholder": "[Placeholder: candidate-specific strength narrative.]",
    "rpt_dev_placeholder": "[Placeholder: candidate-specific development narrative.]",

    "rpt_about_title": "ABOUT THIS ASSESSMENT",
    "rpt_about_text": "This report is generated from behavioural data collected via the Xiberlinc neurocognitive assessment platform. Task paradigms are based on validated scientific protocols: the Visual Working Memory change-detection task (Luck &amp; Vogel, 1997; Cowan, 2001) and the Attention Network Task (Fan et al., 2002). Composite and component scores are derived from candidate performance data. Percentile estimates are illustrative and should not be taken as clinical benchmarks. This report is intended for screening and performance purposes only and does not constitute a clinical diagnosis. Results should be interpreted alongside a qualified evaluator where clinical decisions are involved.",

    "rpt_footer_line": "Xiberlinc · Cognitive Performance Profile",
    "rpt_footer_copyright": "© {year} Xiberlinc Inc. · All rights reserved · Confidential",

    "rpt_cs_cowansk": "Cowan's K",
    "rpt_cs_cowansk_dist": "Cowan's K (Dist.)",
    "rpt_cs_maxn": "Max N",
    "rpt_cs_rteff": "RT Efficiency",
