const DICTIONARY = {
  en: {
    ...
    "rpt_task1_pure": "Task 1 (No Distractor)",
    ...
    "rpt_chart_kcompare_sub": "How memory capacity held up with distractors present.",
    ...
    "rpt_chart_congr_title": "NO DISTRACTOR VS DISTRACTOR ARROWS",
    ...
    "rpt_gloss_congr_term": "No Distractor vs Distractor",
    "rpt_gloss_congr_def": "No Distractor = surrounding arrows point the same direction as the target (easy). Distractor = they point the opposite direction (hard).",
    ...
    "rpt_m_incongruentrt": "Distractor RT",
