const DICTIONARY = {
  en: {
    ...
    "disclaimer_text": "Please secure <strong>12 minutes</strong> to complete this task. If you are not able to complete all tasks in a row within 12 minutes, you will need to try again. The system logs you out automatically.",
    "btn_init": "Start →",
