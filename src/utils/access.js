...
// Constant admin email created in the Firebase console for public admin dashboard auth.
...
/* Secondary Key stubs for Public Edition */
export async function validatePlayerAccess() { return { ok: false }; }
export async function createSecondaryKey() { return { ok: false }; }
export async function getSecondaryKeys() { return []; }
export async function revokeSecondaryKey() {}
export async function reactivateSecondaryKey() {}
